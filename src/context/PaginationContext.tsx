...
interface PaginationContextValue {
    ...
    handleGetPaginationParams: (callback: () => Promise<SearchResults>) => void
}
...
const PaginationProvider: FC<WithChildren> = ({children}) => {
    ...
    const handleGetSearchPage = (url: string) => SearchService.getSearchPage.bind(null, url);
    ...
    const handleGetPaginationParams = async (callback: () => Promise<SearchResults>) => {
